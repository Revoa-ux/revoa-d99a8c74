...
export const SHOPIFY_CONFIG = {
  ...
  REDIRECT_URI: import.meta.env.VITE_SHOPIFY_REDIRECT_URI || "http://localhost:5173/auth/callback",
  APP_URL: import.meta.env.VITE_SHOPIFY_APP_URL || "http://localhost:5173"
};

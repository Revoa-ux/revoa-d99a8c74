...
export const SHOPIFY_CONFIG = {
  ...
  REDIRECT_URI: import.meta.env.VITE_SHOPIFY_REDIRECT_URI || "https://my.revoa.app/auth/callback",
  APP_URL: import.meta.env.VITE_SHOPIFY_APP_URL || "https://my.revoa.app"
};
